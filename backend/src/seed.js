 ...
 *  - 15 products using high-quality Unsplash CDN links
 *  - 3 discount codes (AAMADMII10, NEWUSER20, PREMIUM15)
 *
 * Usage:
...
const products = [
  {
    ...
    inStock: true,
    stockCount: 45,
    thumbnail: 'https://images.unsplash.com/photo-1598033129183-c4f50c736f10?auto=format&fit=crop&q=80&w=800',
  ...
  },
  {
    ...
    inStock: true,
    stockCount: 28,
    thumbnail: 'https://images.unsplash.com/photo-1516257984-b1b4d707412e?auto=format&fit=crop&q=80&w=800',
  ...
  },
  {
    ...
    inStock: true,
    stockCount: 33,
    thumbnail: 'https://images.unsplash.com/photo-1578932750294-f5075e85f44a?auto=format&fit=crop&q=80&w=800',
  ...
  },
  {
    ...
    inStock: true,
    stockCount: 50,
    thumbnail: 'https://images.unsplash.com/photo-1620012253295-c05518e99d67?auto=format&fit=crop&q=80&w=800',
    images: ['https://images.unsplash.com/photo-1620012253295-c05518e99d67?auto=format&fit=crop&q=80&w=800'],
    rating: 4.7,
    reviewCount: 112,
  ...
  },
  {
    ...
    inStock: true,
    stockCount: 30,
    thumbnail: 'https://images.unsplash.com/photo-1603252109303-2751441dd157?auto=format&fit=crop&q=80&w=800',
  ...
  },
  {
    ...
    inStock: true,
    stockCount: 20,
    thumbnail: 'https://images.unsplash.com/photo-1588359348347-9bc6cbaa689e?auto=format&fit=crop&q=80&w=800',
    images: ['https://images.unsplash.com/photo-1588359348347-9bc6cbaa689e?auto=format&fit=crop&q=80&w=800'],
    rating: 4.8,
    reviewCount: 58,
  ...
  },
  {
    ...
    inStock: true,
    stockCount: 35,
    thumbnail: 'https://images.unsplash.com/photo-1583743814966-8936f5b7be1a?auto=format&fit=crop&q=80&w=800',
  ...
  },
  {
    ...
    inStock: true,
    stockCount: 40,
    thumbnail: 'https://images.unsplash.com/photo-1581655353564-df123a1eb820?auto=format&fit=crop&q=80&w=800',
  ...
  },
  {
    ...
    inStock: true,
    stockCount: 35,
    thumbnail: 'https://images.unsplash.com/photo-1479064555552-3ef4979f8908?auto=format&fit=crop&q=80&w=800',
  ...
  },
  {
    ...
    inStock: true,
    stockCount: 12,
    thumbnail: 'https://images.unsplash.com/photo-1621072156002-e2fcc103e86e?auto=format&fit=crop&q=80&w=800',
    images: ['https://images.unsplash.com/photo-1621072156002-e2fcc103e86e?auto=format&fit=crop&q=80&w=800'],
    rating: 4.9,
    reviewCount: 15,
...
const discountCodes = [
  { code: 'AAMADMII10', discountPercent: 10, isActive: true },
...
const seed = async () => {
  ...
  await User.create({
    name: 'Admin User',
    email: 'admin@aamadmii',
    password: 'ahmed96955',
    role: 'admin',
  });
  console.log('✅ Seeded admin user (admin@aamadmii / ahmed96955)');
